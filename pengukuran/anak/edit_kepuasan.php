...
<div class="container">
        ...
        <form action="" method="post">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <tbody>
                            <tr>
                                Indikator
                                <input class="form-control" type="text" name="indikator" id="indikator"  value="Kepuasan Pelanggan" placeholder="Indikator" aria-label="default input example" required readonly>
                            </tr>
                            <tr>
                                Target pelayanan
                                <input class="form-control" type="number" name="target" id="terget" value="90" placeholder="Masukkan angka" aria-label="default input example" readonly>
                            </tr>
                            <tr>
                            ...
                            <tr>
                            Jumlah tidak puas
                                <input class="form-control" type="text" name="data_3" id="data_3" value="<?php echo $data['data_3']?>"  placeholder="Rerata" aria-label="default input example">
                            </tr>
                            <tr>
                                Tanggal
            ...
            <script type="text/javascript">
                            ...
                            var d = parseFloat($("#data_2").val());
                            var e = parseFloat($("#data_3").val());
                            var i = ((a-e)/a)*100;
                            $("#total1").val(i);
                            });
