...
$nama_dokumen='RUANGAN pelayanan ANC';
ob_start();

    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' AND indikator like 'anc'AND tahun LIKE '$tahun'");
	...
	<div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>RUANGAN KIA , KB DAN IMUNISASI</td>
            </tr>
            <tr>
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            <thead>
                <tr>
                    ...
                    <td align="center">Rata-Rata Waktu Pelayanan ANC K1 < 20 menit</td>
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator like 'anc'and tahun LIKE '$tahun'");
                    $data = mysqli_fetch_array($ambilData)
                    ?>
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>">
                        <b>Waktu pelayanan ANC K1 < 20 menit</b></td>
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan'and indikator like 'anc' and tahun LIKE '$tahun'");
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php 
                            $ambilData1= mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'anc'and tahun LIKE '$tahun'");
