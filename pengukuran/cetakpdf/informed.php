...
$nama_dokumen='RUANGAN GIGI DAN MULUT INFORMED';
ob_start();

    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' AND indikator like 'informed'AND tahun LIKE '$tahun'");
	...
	<div>
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator like 'informed'and tahun LIKE '$tahun'");
                    $data = mysqli_fetch_array($ambilData)
                    ?>
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>">
                        <b>Setiap tindakan yang dilakukan menggunakan informed consent</b></td>
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan'and indikator like 'informed' and tahun LIKE '$tahun'");
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php 
                            $ambilData1= mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'informed'and tahun LIKE '$tahun'");
