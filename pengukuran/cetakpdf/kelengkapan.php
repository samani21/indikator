...
$nama_dokumen='RUANGAN KELENGKAPAN TINDAKAN';
ob_start();

    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' AND indikator like 'kelengkapan tindakan'AND tahun LIKE '$tahun'");
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            <thead>
                <tr>
                    ...
                    <td align="center">KETERSEDIAAN OBAT EMERGENCY DI RUANG TINDAKANr</td>
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator like 'kelengkapan tindakan'and tahun LIKE '$tahun'");
                    ...
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>">
                        ...
                        <br>
                        <br>
                        <b>2.Ketersediaan Petugas khusus yang bertugas di ruang tindakan</b></td>
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan'and indikator like 'kelengkapan tindakan' and tahun LIKE '$tahun'");
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php 
                            $ambilData1= mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'kelengkapan tindakan'and tahun LIKE '$tahun'");
