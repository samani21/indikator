...
ob_start();
    ...
    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' and indikator like 'Kepuasan Pelanggan' AND tahun LIKE '$tahun'");
	...
	<div>
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'Kepuasan Pelanggan'AND tahun LIKE '$tahun'");
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'Kepuasan Pelanggan'AND tahun LIKE '$tahun'");
