...
$nama_dokumen='RUANGAN ANAK MTBS';
ob_start();

    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' AND indikator like 'mtbs anak'AND tahun LIKE '$tahun'");
	...
	<div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>RUANGAN PEMERIKSAAN ANAK</td>
            </tr>
            <tr>
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            <thead>
                <tr>
                    ...
                    <td align="center">Pengisian Formulir MTBS balita secara tepat kepada pasien</td>
                    <td align="center">Jumlah pasien balita yang berkunjung di ruang pemeriksaan anak</td>
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator like 'mtbs anak'and tahun LIKE '$tahun'");
                    $data = mysqli_fetch_array($ambilData)
                    ?>
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>">
                    Pengisian Formulir MTBS balita secara tepat kepada pasien
                    </td>
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan'and indikator like 'mtbs anak' and tahun LIKE '$tahun'");
                ...
                <tr>
                    ...
                    <td align="center">
                        <?php 
                            $ambilData1= mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'mtbs anak'and tahun LIKE '$tahun'");
