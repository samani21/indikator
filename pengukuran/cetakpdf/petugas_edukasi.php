...
$nama_dokumen='RUANGAN UMUM';
ob_start();

    $query    =mysqli_query($koneksi, "SELECT * FROM tb_pengukuran WHERE bulan LIKE '$bulan' and indikator like 'petugas edukasi' AND tahun LIKE '$tahun'");
		...
		<table style="border-collapse:collapse;border-spacing:0;" align="center" border="1">
            <thead>
                <tr>
                    ...
                    <td align="center" colspan="2">Petugas promosi kesehatan dan sanitasi Di Ruangan</th>
                    <td align="center" rowspan="2">Jumlah Pasien Yang Berkunjung</th>
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'petugas edukasi'AND tahun LIKE '$tahun'");
                    $data = mysqli_fetch_array($ambilData)
                    ?>
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>">
                    <br>
                    <b>Ketersediaan Petugas Sanitasi dan promkes Di Ruangan (Waktu Pelayanan :Senis - sabtuJam 08.00- 11.00 WITA)</b>
                    <br>
                    <br>
                    <b>Sanitasi : Selasa,Jum'at Promkes :Senis, rabu, kamis, sabtu</b>
                </td>
                  ...
                  <td height="1"></td>
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE bulan LIKE '$bulan' and indikator LIKE 'petugas edukasi'AND tahun LIKE '$tahun'");
                ...
                <tr>
                    ...
                    <td align="center" colspan="3" >
                        <?php 
                            $ambilData1= mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE bulan LIKE '$bulan'and indikator like 'petugas edukasi'AND tahun LIKE '$tahun'");
