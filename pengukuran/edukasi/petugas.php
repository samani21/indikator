                ...
                <table>
                    ...
                    <th>
                        <div class="dropdown">
                            ...
                            <?php
                                include "../../asset/koneksi/koneksi.php";
                                $query= mysqli_query($koneksi,"SELECT DISTINCT(bulan),tahun FROM tb_pengukuran WHERE indikator LIKE 'petugas edukasi'");
                                while ($da = mysqli_fetch_array($query)){
                            ?>
                                <li><a class="dropdown-item" href="../cetakpdf/petugas_edukasi.php?bulan=<?php echo $da['bulan'];?>&tahun=<?php echo $da['tahun']?>"><?php echo $da['bulan'];?>  <?php echo $da['tahun'];?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
        ...
        <div class="row">
            <div class="table-responsive" id="no-more-tables">
                ...
                <tr>
                    ...
                    <td align="center" colspan="2">Petugas promosi kesehatan dan sanitasi Di Ruangan</td>
            ...
            <tbody>
                <tr>
                    <?php 
                    $ambilData = mysqli_query($koneksi,"SELECT COUNT(tanggal) AS tgl FROM `tb_pengukuran` WHERE indikator LIKE 'petugas edukasi'");
                    ...
                    <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_pengukuran` WHERE indikator LIKE 'petugas edukasi'");
