        ...
        <br>
            <div class="row g-3">
                <div class="col-6 col-md-4 col-lg-2">
                    <a href="informed.php" class="text-dark" style="text-decoration: none;">
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <a href="apd_antibiotik.php" class="text-dark" style="text-decoration: none;">
                        <div class="card">
                            <div class="card-body">
                              <h5 class="card-title">Petugas APD,Antibiotik</h5>
                            </div>
                          </div>
                    </a>
                </div>
