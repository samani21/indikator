                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <tbody>
                            <tr>
                                Indikator
                                <input class="form-control" type="text" name="indikator" id="indikator"  value="Waktu tunggu pasien rawat jalan" placeholder="Indikator" aria-label="default input example" required>
                            </tr>
                            <tr>
                                Target
