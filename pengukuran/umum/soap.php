                ...
                <table>
                    ...
                    <th>
                        <div class="dropdown">
                            ...
                            ?>
                                <li><a class="dropdown-item" href="../cetakpdf/soap_umum.php?bulan=<?php echo $da['bulan'];?>&tahun=<?php echo $da['tahun']?>"><?php echo $da['bulan'];?> <?php echo $da['tahun']?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
            ...
            <tbody>
                <tr>
                    ...
                    <td rowspan="<?php $tambah= $data['tgl'] + 1; echo $tambah ?>" data-title="Indikator">
                        <b>Kelengkapan pengisian rekam medis pasien ruang pemeriksaan umum sesuai SOAP</b>
                    </td>
