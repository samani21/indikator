...
$excel->setActiveSheetIndex(0)->setCellValue('B1', "RUANGAN GIGI"); 
...
$sql = $pdo ->prepare("SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan gigi'AND tahun LIKE '$tahun'");
$sql->execute(); 
$no = 1; 
$numrow = 4; 
...
header('Content-Disposition: attachment; filename="Data ruangan gigi.xlsx"'); 
