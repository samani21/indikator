...
$excel->setActiveSheetIndex(0)->setCellValue('B1', "RUANGAN GIZI"); 
...
$sql = $pdo ->prepare("SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan gizi'AND tahun LIKE '$tahun'");
$sql->execute(); 
$no = 1; 
$numrow = 4; 
...
header('Content-Disposition: attachment; filename="Data ruangan gizi.xlsx"'); 
