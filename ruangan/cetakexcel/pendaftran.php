...
$excel->setActiveSheetIndex(0)->setCellValue('B1', "RUANGAN PENDAFTARAN dan REKAM MEDIS"); 
...
$sql = $pdo ->prepare("SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan pendaftran dan rekam medis'AND tahun LIKE '$tahun'");
$sql->execute(); 
$no = 1; 
$numrow = 4; 
...
header('Content-Disposition: attachment; filename="Data ruangan pendaftaran dan rekam medis.xlsx"'); 
