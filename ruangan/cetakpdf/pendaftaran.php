...
$nama_dokumen='RUANGAN PENDAFTARAN dan REKAM MEDIS';
ob_start();
?>
...
<body>
	<div>
		<h2 align="center">RUANGAN PENDAFTARAN dan REKAM MEDIS</h2>
        <hr>
        ...
        <thead>
                      ...
                      <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan pendaftran dan rekam medis' AND tahun LIKE '$tahun'");
