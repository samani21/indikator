...
<body>
	<div>
		<h2 align="center">RUANGAN TINDAKAN</h2>
        <hr>
        ...
        <thead>
                      ...
                      <?php
                        include "../../asset/koneksi/koneksi.php";
                        $no=1;
                        $data= mysqli_query($koneksi,"SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan tindakan' AND tahun LIKE '$tahun'");
