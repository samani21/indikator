...
<div class="container">
        <div class="row">
            <section class="bg-light ">
                ...
                <table>
                    <th>
                        <a href="aksi/tambah_farmasi.php"class="btn btn-primary" >Tambah Data</a>
                    </th>
                    <th>
                        <div class="dropdown">
                            ...
                            ?>
                                <li><a class="dropdown-item" href="cetakexcel/farmasi.php?tahun=<?php echo $da['tahun'];?>"><?php echo $da['tahun'];?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
                    ...
                    <th>
                        <div class="dropdown">
                            ...
                            <?php
                                ...
                                while ($da = mysqli_fetch_array($query)){
                            ?>
                                <li><a class="dropdown-item" href="cetakpdf/farmasi.php?tahun=<?php echo $da['tahun'];?>"><?php echo $da['tahun'];?></a></li>
                                <?php
                                }
                                ?>
                            </ul>
            ...
            <div class="table-responsive" id="no-more-tables">
                ...
                <thead>
                        ...
                        <?php
                            include "../asset/koneksi/koneksi.php";
                            $no=1;
                            $query= mysqli_query($koneksi,"SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan farmasi' ORDER BY tahun DESC");
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td data-title="Action" align="center"><a href="aksi/edit_farmasi.php?id=<?php echo $data['id']; ?>"class="btn btn-warning">Edit</a>
                        <a href="aksi/hapus_farmasi.php?id=<?php echo $data['id']; ?>" class="btn btn-danger">Hapus</a></td>
                        </tr>
                        <?php
                            }
                        ?>
