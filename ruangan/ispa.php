        ...
        <div class="row">
            <section class="bg-light ">
                ...
                <table>
                    ...
                    <th>
                        <a href="cetakexcel/ispa.php"class="btn btn-warning" >Cetak Data Excel</a>
                    </th>
                    <th>
                        <a href="cetakpdf/ispa.php"class="btn btn-warning" >Cetak Data PDF</a>
                    </th>
                </table>
            </section>
        </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <?php
                            ...
                            $no=1;
                            $query= mysqli_query($koneksi,"SELECT * FROM `tb_indikator` WHERE ruangan LIKE 'Ruangan ispa'");
